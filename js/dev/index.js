import { g as getHash, d as dataMediaQueries, s as slideDown, a as setHash, b as slideUp, c as bodyLock, e as bodyUnlock, f as bodyLockStatus, h as bodyLockToggle } from "./common.min.js";
(function polyfill() {
...
function initSliders() {
  if (document.querySelector(".clients__slider")) {
    new Swiper(".clients__slider", {
      ...
      fadeEffect: {
        crossFade: true
        // старый слайд растворяется при появлении нового
      },
      //   autoplay: {
      //     delay: 3000,
      ...
      */
      // Кнопки "вліво/вправо"
      navigation: {
        prevEl: ".prev-clients-button",
        nextEl: ".next-clients-button"
      },
      /*
      // Брейкпоінти
      breakpoints: {
  ...
  if (document.querySelector(".portfolio__slider")) {
    new Swiper(".portfolio__slider", {
      ...
      //   effect: "fade",
      //   fadeEffect: {
      //     crossFade: true, // старый слайд растворяется при появлении нового
      //   },
      //   autoplay: {
      //     delay: 3000,
      //     disableOnInteraction: false,
      ...
      // Кнопки "вліво/вправо"
      navigation: {
        prevEl: ".prev-portfolio-button",
        nextEl: ".next-portfolio-button"
      },
      // Брейкпоінти
      breakpoints: {
        640: {},
        ...
        992: {
          slidesOffsetAfter: 705,
          slidesPerView: "auto",
          centeredSlides: false
        },
        1024: {
          slidesOffsetAfter: 730,
          slidesPerView: "auto",
          centeredSlides: false
        },
        1050: {
          slidesOffsetAfter: 760,
          slidesPerView: "auto",
          centeredSlides: false
        },
        1100: {
